...
def game():
    ...
    def batting():
        ...
        while True:
            ...
            print("computer bowls :",computer_bowls)
            num1_balls+=1
            if player_bats==computer_bowls:
                ...
                print("\nPlayer current score is: ",bat1_score)
                print("Number of balls faced:",num1_balls)
        ...
        while True:
            ...
            if computer_bats==player_bowls:
                ...
                print("\nComputer current score is: ",bat2_score)
    ...
    def bowling():
        ...
        while True:
            ...
            if computer_bats==player_bowls:
                ...
                print("\nComputer current score is: ",bat1_score)
                print("Number of balls faced:",num1_balls)
        ...
        while True:
            ...
            if player_bats==computer_bowls:
                ...
                print("\nPlayer current score is: ",bat2_score)
                print("Number of balls faced:",num2_balls)
